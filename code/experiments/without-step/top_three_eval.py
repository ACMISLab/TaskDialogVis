...
def accuracy_eval(candidates_chart, references_chart):
    ...
    # if (candidates_chart_ast == references_chart_ast or candidates_chart_ast2 == references_chart_ast2) and candidates_filter_ast == references_filter_ast:
    #     return True
    return True
...
#                         "transform": [
#                             {
#                                 "filter": "(datum.sex === 1 && datum.chest_pain_type === 3) || (datum.age >= 50 && datum.cholesterol > 250)"
#                             }
#                         ],
#                         "mark": "point",
#                         "encoding": {
...
#                     }
#
# print(accuracy_eval(c1, c2))

with open(r"output/deepseek_r1-check.json", "r", encoding="utf-8") as file:
    output = file.read()
    ...
    for i, chart in enumerate(tqdm(dio["dialogues"])):
        ...
        for n in chart["charts"]:
            try:
                ...
                task_list = [n["analyzing tasks"], ture_data[index]["dialogues"][i]["analyzing tasks"]]
                ...
                if bleu > max_bleu:
                    max_bleu = bleu
                if n["analyzing tasks"] == ture_data[index]["dialogues"][i]["analyzing tasks"]:
                    true_task = True
...
print(consistency)
print(task)
# print(percentage_of_dialogues_correct / 117)
# print(diolage)
