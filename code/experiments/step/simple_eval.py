...
for index, dio in enumerate(tqdm(output)):
    ...
    for i, chart in enumerate(tqdm(dio["dialogues"])):
        ...
        task_list = [chart["analytic task"], ture_data[index]["dialogues"][i]["analytic task"]]
        if ture_data[index]["dialogues"][i]["analytic task"] not in task_count:
            task_count[ture_data[index]["dialogues"][i]["analytic task"]] = 1
        else:
            task_count[ture_data[index]["dialogues"][i]["analytic task"]] += 1
        ...
        print(chart["analytic task"], ture_data[index]["dialogues"][i]["analytic task"])

        if chart["analytic task"] == ture_data[index]["dialogues"][i]["analytic task"]:
            task_num += 1
            if ture_data[index]["dialogues"][i]["analytic task"] not in task_right_count:
                task_right_count[ture_data[index]["dialogues"][i]["analytic task"]] = 1
            else:
                task_right_count[ture_data[index]["dialogues"][i]["analytic task"]] += 1
